...
$sql="Select  a.dia_ordi,a.fecha_ordi,a.horai_ordi,a.horaf_ordi,a.aula_ordi,a.materia,a.matricula,a.alumno,a.clave,a.grupo,a.expediente,a.maestro 
from alumnos a left join ofertaacademica o on a.clave=o.clave and a.grupo=o.grupo and a.expediente=o.expediente 
            ...
            /*'copyHtml5',*/
             {
                ...
                text:"Exporta Excel",
                title:"alumnos_no_match_oferta_academica_"+(GetTodayDate()),
            },
            {
            /*'csvHtml5',*/
                extend: 'pdf',
...
<div class = "row">
    <div class="col-md-12"><h1 class="text-center">Reporte de alumnos que no hay coincidencia(clave,grupo,expediente) para oferta Academica</h1></div>
</div><!--fin del row -->
