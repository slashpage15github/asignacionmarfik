		...
		<div class="container">
			...
			<form class="form-horizontal" method="POST" action="update.php" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    	<input type="text" class="form-control" name="cve_mat" id="cve_mat" disabled value="<?php echo $row['materia']; ?>" disabled>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea type="text" class="form-control" rows="4" cols="50" id="observaciones" name="observaciones" placeholder="Observaciones" charset="utf-8" disabled><?php echo $row['observaciones'];?></textarea>
                    </div>
                </div>
