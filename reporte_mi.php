...
<head>
    ...
    <title>Reporte Alumnos Con Ingles</title>
    <!-- Bootstrap Core CSS -->
            ...
            /*'copyHtml5',*/
             {
                ...
                text:"Exporta Excel",
                title:"reporte_alumnos_ingles_"+(GetTodayDate()),
            },
            {
            /*'csvHtml5',*/
                extend: 'pdf',
...
<body>
    ...
    <div container-fluid" align="center">
        <div class="col-md-12">
            ...
            <div class = "row">
                <div class="col-md-12"><h1 class="text-center">Reporte Alumnos Con Ingles</h1></div>
            </div><!--fin del row -->
            <div class="row">
