...
<head>
    ...
    <title>Asignación puntual Extraordinario Individual</title>
    <!-- Bootstrap Core CSS -->
    ...
    <script>
        function valida_matricula() {
            if(document.getElementById("matric").value.length==0 || document.getElementById("matric").value.length<4)
            {
                ...
                $.ajax({
                    ...
                    url:'log_forma_alumnos_extra_abc.php',
        ...
        function limpia_dato(){
            window.location.assign("consulta_extra_alumno.php");
        }
    </script>
</head>
<body>
    ...
    <div id = "contenedor">
        <div class="col-md-12">
            <form class="form-inline" action="log_forma_alumnos_extra_abc.php" method="POST">
                ...
                <div class = "row">
                    <div class="col-md-12"><h1 class="text-center">Modificación de Alumno (Extraordinarios)</h1></div>
