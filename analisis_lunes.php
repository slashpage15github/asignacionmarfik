<?php
  ...
  $sql="select alumnos,clave,materia,grupo,expediente,maestro,hilunes,hflunes,
mlunes,slunes 
from ofertaacademica
where (hilunes is not null and hilunes<>'')
ORDER BY slunes asc,hilunes asc";
//print $sql;exit;
...
<head>
    ...
    <title>Analisis de oferta academica Lunes</title>
    <!-- Bootstrap Core CSS -->
            ...
            /*'copyHtml5',*/
             {
                ...
                text:"Exporta Excel",
                title:"Analisis de oferta academica Lunes"+(GetTodayDate()),
            },
            {
            /*'csvHtml5',*/
                extend: 'pdf',
...
<body>
    ...
    <div container-fluid" align="center">
        <div class="col-md-12">
            ...
            <div class = "row">
                <div class="col-md-12"><h1 class="text-center">Analisis de oferta academica Lunes</h1></div>
            </div><!--fin del row -->
            <div class="row">
                <table id="datatables" class="table table-bordered table-hover dataTable" role="grid" >
                    ...
                    <tbody>
                            ...
                            while($row=mysqli_fetch_array($resultado,MYSQLI_ASSOC)){
                                ...
                                $mlunes=trim(utf8_encode($row["mlunes"]));
