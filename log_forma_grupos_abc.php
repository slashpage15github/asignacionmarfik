...
<head>
	...
	<title>Modificación de horario Ordinario forma grupal</title>
</head>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12 text-center">
				<h1 class="sinMargen"><a class="btn btn-danger" href="consulta_grupal_ord.php" role="button">Buscar Materia</a>&nbsp;&nbsp;Ajuste Grupal-Alumnos en Ordinarios</h1>
		...
		<?php
			...
			//incluye las clases
			include_once ("log_clase_grupos_abc.php");

			$_matricula=""; $_alumno=""; $_clave=""; $_grupo="";$_expediente=""; $_maestro=""; $_materia=""; 
			$_dia_ordi=""; $_fecha_ordi=""; $_horai_ordi=""; $_horaf_ordi=""; $_aula_ordi=""; $_dia_extra=""; 
			$_fecha_extra=""; $_horai_extra=""; $_horaf_extra=""; $_aula_extra=""; $alumno="";
			...
			if (isset($_GET['md']) and isset($_GET['exp']) AND isset($_GET['cve']) AND isset($_GET['gpo'])) {
				...
				$o_grupo = new Grupo($_GET['exp'],$_GET['cve'],$_GET['gpo']);
				...
				$_dia_ordi = $o_grupo->getDiaOrdi();
				$_fecha_ordi = $o_grupo->getFechaOrdi();
				$_horai_ordi = $o_grupo->getHoraiOrdi();
				$_horaf_ordi = $o_grupo->getHorafOrdi();
				$_aula_ordi = $o_grupo->getAulaOrdi();
		...
		<div id="container">
		<form action="log_forma_grupos_abc.php" name="grupo_ordi" onsubmit="return valida_grupo_ordi();" method="post">
				...
				<div class='col-md-12'>
                	...
                	<div class="col-md-2 form-group">
                		<label>Fecha</label>
                    	<input type="text" id="f_fecha" name="f_fecha" class="form-control" value="<?=$_fecha_ordi;?>" style='background: white;font-weight:bold;text-align:left;font-size:20px;color:red;' readonly>
                	</div>
                	<div class="col-md-2 form-group">
                    	<label>Día</label>
                    	<input type="text" id="f_dia" name="f_dia" class="form-control" value="<?=utf8_encode($_dia_ordi);?>" style='background: white;font-weight:bold;text-align:left;font-size:20px;color:red;' readonly>
                    </div>
				</div>
				...
				<div class='col-md-12'>
                	<div class="col-md-2 form-group">
                    	...
                    	<input  type="text" id="f_hi" name="f_hi" class="form-control" value="<?=$_horai_ordi;?>" style='background: white;font-weight:bold;text-align:left;font-size:20px;color:red;'>
                	</div>
                	<div class="col-md-2 form-group">
                    	<label>Hora Fin</label>
                    	<input type="text" id="f_hf" name="f_hf" class="form-control" value="<?=$_horaf_ordi;?>" style='background: white;font-weight:bold;text-align:left;font-size:20px;color:red;'>
                	</div>
                	<div class="col-md-6 form-group">
                    	<label>Aula</label>
						...
						<?php
							...
							saca_menu_desplegable_boostrap($consulta,$_aula_ordi, "f_aula_ordi", "f_aula_ordi");
		 				?>
                	</div>
                	<div class="col-md-2 form-group">
		...
		<?php
			...
			{	
				...
				$o_grupo=new Grupo($_POST['f_exp'],$_POST['f_cve'],$_POST['f_gpo']);  // instancio la clase pasandole el nro de cliente para cargar los datos
				$o_grupo->setFechaOrdi($_POST['f_fecha']); // setea los datos nuevos
				$o_grupo->setDiaOrdi($_POST['f_dia']);
				$o_grupo->setHoraiOrdi($_POST['f_hi']);
				$o_grupo->setHorafOrdi($_POST['f_hf']);
				$o_grupo->setAulaOrdi($_POST['f_aula_ordi']);

				print '<span style="color:red;">¡Horario grupal ordinario modificado!</span>'. $o_grupo->updateGrupoOrdi();
			}
			...
			$_pagi_sql ="select clave, grupo,expediente,maestro, materia, dia_ordi, fecha_ordi, horai_ordi, horaf_ordi, aula_ordi from gruposmaestros where materia like "."'%".$_SESSION[
				'$materiaa']."%'";
								...
								<center>
									...
									while($row = mysql_fetch_array($_pagi_result)) {
											print 	'<tr>'
												...
												.'<td><a href="log_forma_grupos_abc.php?exp='.$row['expediente'].'&gpo='.$row['grupo'].'&cve='.$row['clave'].'&md='.$_SESSION['$materiaa'].'&_pagi_pg='.$_pagi_pg.'"><img src="pics/modificar.png" border="0" style="position:relative;left:12px;"></a></td>'   
												.'</tr>';									}
									echo '</table>';
								echo '</center>';
							echo '</div>';
