...
if (isset($_POST['semestre'])){
      ...
      $semestreuno = $_POST['semestreuno'];
      $tipo_examenuno = $_POST['tipo_examenuno'];
      //$mensaje = array();     
}
else{
      echo 'no llego el id';
...
if (!$conexion){
    ...
    exit;
      ...
      $query= "update parametros_fecha_examen_depa set semestre='$semestre', tipo_examen='$tipo_examen', f_inicio='$fecha_inicio', f_fin='$fecha_final' where semestre='$semestre'";
