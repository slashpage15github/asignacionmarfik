...
if (isset($_POST['salon'])){
      ...
      $caracteristica =strtoupper(utf8_decode($_POST['caracteristica']));
      $mensaje = array();     
}
else{
      echo 'no llego el id';
...
if (!$conexion){
    ...
    exit;
      ...
      $consulta = mysqli_query($conexion, "insert into capacidadaulas(salon, capacidad, piso, caracteristica) values('$salon', '$capacidad', '$piso', '$caracteristica')");
