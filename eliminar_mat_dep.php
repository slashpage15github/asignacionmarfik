...
if (!$conexion){
    ...
    exit;
      ...
      $consulta = mysqli_query($conexion, "delete from catalogo_materias_depa where cve_mat ='$cve_mat'");
...
//if ($filas === 0) {
   ...
   //   echo json_encode("bORRADO");
            ...
            header('Location: log_forma_mat_departamentales_abc.php');
