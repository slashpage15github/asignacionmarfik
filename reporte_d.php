...
where o.departamental not in ('ND','MI')";
/*
    $sql="select matricula,alumno,cve_plan,grado,seccion,turno,estatus,a.clave,a.materia,a.expediente,a.maestro,a.grupo,
    CVE_PLANA,CVE_MATA,PLANAC,oportunidad,a.observacion,dia_ordi,fecha_ordi,horai_ordi,horaf_ordi,aula_ordi,dia_extra,fecha_extra,
    horai_extra,horaf_extra,aula_extra,alumnos,progra_grupo,
    horas,lunes,hilunes,hflunes,mlunes,alunes,slunes,
        martes,himartes,hfmartes,mmartes,amartes,smartes,miercoles,himiercoles,hfmiercoles,mmiercoles,amiercoles,smiercoles,
        jueves,hijueves,hfjueves,mjueves,ajueves,sjueves,viernes,hiviernes,hfviernes,mviernes,aviernes,sviernes,sabado,hisabado,
        hfsabado,msabado,asabado,ssabado,departamental,semestre 
from alumnos a join ofertaacademica o on a.clave=o.clave and a.grupo=o.grupo and a.expediente=o.expediente
where o.departamental not in ('ND','MI')";
*/
...
<body>
    ...
    <div container-fluid" align="center">
        <div class="col-md-12">
            ...
            <div class = "row">
                <div class="col-md-12"><h1 class="text-center">Reporte Alumnos Con Materias Departamentales</h1></div>
            </div><!--fin del row -->
            <div class="row">
