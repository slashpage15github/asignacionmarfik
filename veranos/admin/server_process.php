...
exit;
	...
	*/
	...
	$aColumnas = array( 'id_especial','matricula', 'cve_mat', 'email', 'telefono', 'estatus', 'grado', 'carrera', 'nombre', 'observaciones','x' );
	
	/* columna indexada */
	$sIndexColumn = "id_especial";
	...
	*/
	...
	{
		$row = array();
		$row[] = "<td><a href='modificar.php?id_especial=".$aRow['id_especial']."'><span class='glyphicon glyphicon-pencil'></span></a></td>";
		$row[] = "<td><a href='#' data-href='delete.php?id_especial=".$aRow['id_especial']."' data-toggle='modal' data-target='#confirm-delete'><span class='glyphicon glyphicon-trash'></span></a></td>";
		for ( $i=0 ; $i<count($aColumnas) ; $i++ )
		{
