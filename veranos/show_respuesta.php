...
FROM
	veranos e
LEFT JOIN alumnos a ON e.matricula = a.matricula
AND e.cve_mat = a.clave
WHERE
	e.matricula = '$matricula';";*/
//$sql = "SELECT id_especial, matricula, cve_mat, email from especiales where matricula = '$matricula'";
...
<head>
	...
	<title>Materias para Verano Solicitadas</title>
	<meta charset="UTF-8">
</head>
<body>
	<div class="row">
	...
	<h1>Materias para Verano Solicitadas&nbsp &nbsp&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <img src="images/logo.png"  width="200"></h1>
	<div class="row">
