		...
		<div class="container">
			...
			<form class="form-horizontal" method="POST" action="update.php" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select name="cve_mat" id="cve_mat" class="form-control">
                            <option value="<?php echo $row['cve_mat'];?>" selected><?php echo utf8_encode($row['materia']); ?></option>
                            </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea type="text" class="form-control" rows="4" cols="50" id="observaciones" name="observaciones" placeholder="Observaciones" disabled><?php echo utf8_encode($row['observaciones']);?></textarea>
                    </div>
                </div>
