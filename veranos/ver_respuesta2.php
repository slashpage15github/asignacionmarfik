<?php
	...
	/*$sql = "Select * from especiales where id_especial = '$id_especial';";*/
	$sql = "SELECT
	e.matricula,
	e.nombre,
	e.carrera,
		...
		<div class="container">
			...
			<form class="form-horizontal" method="POST" action="update.php" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    	<input type="text" class="form-control" name="cve_mat" id="cve_mat" disabled value="<?php echo utf8_encode($row['materia']); ?>" disabled>
                        <!--<select name="cve_mat" id="cve_mat" disabled>
                            <option value="0" selected><?php echo utf8_encode($row['materia']); ?></option>
                            </select>-->
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea type="text" class="form-control" rows="4" cols="50" id="observaciones" name="observaciones" placeholder="Observaciones" charset="utf-8" disabled><?php echo utf8_encode($row['observaciones']);?></textarea>
                    </div>
                </div>
                ...
                <div hidden class="form-group">
                    <label for="nombre" class="col-sm-2 control-label">Nombre</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="clave" name="clave" placeholder="Nombre" value="<?php echo $row['carrera']; ?>" disabled>
                    </div>
                </div>
				
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<a href="show_respuesta.php" class="btn btn-default">Regresar</a>
