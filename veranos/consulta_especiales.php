...
<head>
	<meta charset="utf-8">
	<title>Materias pata verano solicitud</title>
...
<body>
	...
	<h1>Solicitud Materias para Verano &nbsp &nbsp&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <img src="images/logo.png"  width="200"></h1>
	<div class = "row">
