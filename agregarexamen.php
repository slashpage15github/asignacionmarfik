...
if (!$conexion){
    ...
    exit;
      ...
      $consulta = mysqli_query($conexion, "insert into parametros_fecha_examen_depa(semestre, tipo_examen, f_inicio, f_fin) values('$semestre', '$tipo_examen', '$fecha_inicio', '$fecha_final')");
