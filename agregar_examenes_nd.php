<?php
    ...
    $sql="select MAX(id) as id from parametros_dias_no_departamentales";
             ...
             <input type="hidden" name="idsecreto" id="idsecreto" value="<?=$id;?>">
                 <div class="form-group">
                    ...
                    <div class="input-group col-md-10">
                        <input type="date" name="fecha_examen" id="fecha_examen" value="<?php echo date("Y-m-d");?>" class="form-control">
        ...
        $(document).ready(function(){
            ...
            $("#btnguardar").click(function(){                
                ...
                if(id=="" || dia=="" || fecha==""){
                    ...
                    $.post("agregarexamennd.php", {id: id, dia:dia, fecha:fecha}, function() {
