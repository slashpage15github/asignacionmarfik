<?php
    ...
    $sql="select * from capacidadaulas where salon='$salon' and capacidad='$capacidad'";
    ...
    <div class="container-fluid" align="center">
        ...
        <?php
            while($row=mysqli_fetch_array($resultado,MYSQLI_ASSOC)){
                ...
                $capacidad=trim(strtoupper(utf8_encode($row["capacidad"])));
                $piso=trim(utf8_encode($row["piso"]));
                $caracteristica=trim(strtoupper(utf8_encode($row["caracteristica"])));                               
        ?>      
        
                  <div class="form-group">
                    <label class="col-md-3 control-label">Salon:</label>    
                    <div class="input-group col-md-9">
                        <input type="text" name="salon" id="salon" value="<?=$salon;?>" class="form-control">  
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-md-9">
                        <input type="text" name="capacidad" id="capacidad" value="<?=$capacidad;?> " class="form-control">  
                        <span class="input-group-addon"><i class="glyphicon glyphicon-file"></i></span>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-md-9">
                        <input type="text" name="piso" id="piso" value="<?=$piso;?>" class="form-control">  
                        <span class="input-group-addon"><i class="glyphicon glyphicon-file"></i></span>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-md-9">
                        <input type="text" name="caracteristica" id="caracteristica" value="<?=$caracteristica;?>" class="form-control">  
                        <span class="input-group-addon"><i class="glyphicon glyphicon-file"></i></span>
                    </div>
                </div>
                </div>
    ...
    <script>
        $(document).ready(function(){
            $("#btnguardar").click(function(){
                ...
                $.post("editarsalon.php", {salon: salon, capacidad:capacidad, piso:piso, caracteristica:caracteristica}, function() {
