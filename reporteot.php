...
$sql=" select alumnos,clave,materia,progra_grupo, grupo, expediente, maestro, departamental, semestre, observacion
  from ofertaacademica where departamental not in ('MD','ND','MI')";
...
<body>
    ...
    <div container-fluid" align="center">
        <div class="col-md-12">
            ...
            <div class = "row">
                <div class="col-md-12"><h1 class="text-center">Reporte de Otras Materias</h1></div>
            </div><!--fin del row -->
            <div class="row">
