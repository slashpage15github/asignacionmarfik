...
$sql="SELECT a.matricula, a.alumno,a.cve_plan, a.materia, a.clave,a.expediente, a.maestro, a.grupo,a.dia_ordi,a.fecha_ordi,a.horai_ordi,a.horaf_ordi,a.aula_ordi,a.dia_extra,a.fecha_extra,a.horai_extra,a.horaf_extra,a.aula_extra FROM alumnos a
left join gruposmaestros g on a.clave = g.clave and a.grupo=g.grupo and a.expediente=g.expediente
where g.clave is NULL 
...
<title>Alumnos sin horarios</title>
    <!-- Bootstrap Core CSS -->
            ...
            /*'copyHtml5',*/
             {
                ...
                text:"Exporta Excel",
                title:"Alumnos sin horario"+(GetTodayDate()),
            },
            {
            /*'csvHtml5',*/
                extend: 'pdf',
...
<div class = "row">
    <div class="col-md-12"><h1 class="text-center">Alumnos sin horarios</h1></div>
</div><!--fin del row -->
...
<?php
    while($row=mysqli_fetch_array($resultado,MYSQLI_ASSOC)){
            ...
            $grupo=trim($row["grupo"]);$dia_ordi=trim(utf8_encode($row["dia_ordi"]));
