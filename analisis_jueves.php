<?php
  ...
  $sql="select alumnos,clave,materia,grupo,expediente,maestro,hijueves,hfjueves,
mjueves,sjueves 
from ofertaacademica
where (hijueves is not null and hijueves<>'')
ORDER BY sjueves asc,hijueves asc";
//print $sql;exit;
...
<head>
    ...
    <title>Analisis de oferta academica Jueves</title>
    <!-- Bootstrap Core CSS -->
            ...
            /*'copyHtml5',*/
             {
                ...
                text:"Exporta Excel",
                title:"Analisis de oferta academica Jueves"+(GetTodayDate()),
            },
            {
            /*'csvHtml5',*/
                extend: 'pdf',
...
<body>
    ...
    <div container-fluid" align="center">
        <div class="col-md-12">
            ...
            <div class = "row">
                <div class="col-md-12"><h1 class="text-center">Analisis de oferta academica Jueves</h1></div>
            </div><!--fin del row -->
            <div class="row">
                <table id="datatables" class="table table-bordered table-hover dataTable" role="grid" >
                    ...
                    <tbody>
                            ...
                            while($row=mysqli_fetch_array($resultado,MYSQLI_ASSOC)){
                                ...
                                $mjueves=trim(utf8_encode($row["mjueves"]));
