...
$proce=mysqli_query($conexion,"CALL horas_empalmadas_extra();") or die("Fallo : fall en rocedimient horas_empalmadas_extra" . mysqli_error());


if ($proce!=1){
print 'Error al ejecutar el procedimiento horas_empalmadas_extra, verifique la programación:'.$proce;return;
}

$sql="select fecha_extra,
  veces,
  matricula,
  alumno,
  clave,
  ...
  horai_extra,
  horaf_extra
from incidencias_empalme_horas_extra
order by veces,fecha_extra,matricula;";
//print $sql;exit;
            ...
            /*'copyHtml5',*/
             {
                ...
                text:"Exporta Excel",
                title:"alumnos_con_empalme_horas_extraordinario_"+(GetTodayDate()),
            },
            {
            /*'csvHtml5',*/
                extend: 'pdf',
...
<div class = "row">
    <div class="col-md-12"><h1 class="text-center">Reporte de alumnos con empalme de horario por dia en extraordinarios.</h1></div>
</div><!--fin del row -->
