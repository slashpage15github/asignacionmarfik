...
if (isset($_POST['salon'])){
      ...
      $piso = $_POST['piso'];
      $caracteristica = utf8_decode(strtoupper($_POST['caracteristica']));
...
if (!$conexion){
    ...
    exit;
      ...
      $query= "update capacidadaulas set salon='$salon', capacidad='$capacidad', piso='$piso', caracteristica='$caracteristica' where salon='$salon'";
