...
$proce0=mysqli_query($conexion,"truncate empalme_salones;") or die("Fallo : fallo en procedimiento empalmes_salones_lunes-raro" . mysqli_error($conexion));
$proce1=mysqli_query($conexion,"CALL empalmes_salones_lunes();") or die("Fallo : fallo en procedimiento empalmes_salones_lunes-proc" . mysqli_error($conexion));
$proce2=mysqli_query($conexion,"CALL empalmes_salones_martes();") or die("Fallo : fallo en procedimiento empalmes_salones_lunes" . mysqli_error($conexion));
$proce3=mysqli_query($conexion,"CALL empalmes_salones_miercoles();") or die("Fallo : fallo en procedimiento empalmes_salones_lunes" . mysqli_error($conexion));
$proce4=mysqli_query($conexion,"CALL empalmes_salones_jueves();") or die("Fallo : fallo en procedimiento empalmes_salones_lunes" . mysqli_error($conexion));
$proce5=mysqli_query($conexion,"CALL empalmes_salones_viernes();") or die("Fallo : fallo en procedimiento empalmes_salones_lunes" . mysqli_error($conexion));
$proce6=mysqli_query($conexion,"CALL empalmes_salones_sabado();") or die("Fallo : fallo en procedimiento empalmes_salones_lunes" . mysqli_error($conexion));



if ($proce0!=1 or $proce1!=1 or $proce2!=1 or $proce3!=1 or $proce4!=1 or $proce5!=1 or $proce6!=1){
print 'Error al ejecutar el procedimiento empalmes_salones_lunes, verifique la programación:'.$proce;return;
}

$sql="select * from empalme_salones ORDER BY dia_empalme;";
//print $sql;exit;
...
<div class = "row">
    <div class="col-md-12"><h1 class="text-center">Reporte de materias con empalme de salones.</h1></div>
</div><!--fin del row -->
