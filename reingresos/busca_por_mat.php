...
<?php include "menu.php"; ?>
	...
	<h1>Formulario de búsqueda de registros por Matricula &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <img src="images/logo.png"  width="200"></h1>

<div class="container">	
	<form action="listado_busqueda.php" method="post" accept-charset="utf-8" onsubmit="return  valida_usuario_busca();">
