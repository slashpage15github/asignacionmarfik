<?php
    ...
    $sql="select matricula,alumno,cve_plan,grado,clave,materia,expediente,maestro,grupo,oportunidad,
        observacion,dia_ordi,fecha_ordi,horai_ordi,horaf_ordi,aula_ordi,dia_extra,fecha_extra,horai_extra,horaf_extra,aula_extra
            ...
            /*'copyHtml5',*/
             {
                ...
                text:"Exporta Excel",
                title:"listado_general_de_alumnos_"+(GetTodayDate()),
            },
            {
            /*'csvHtml5',*/
                extend: 'pdf',
...
<body>
    ...
    <div container-fluid" align="center">
        <div class="col-md-12">
            ...
            <div class = "row">
                <div class="col-md-12"><h1 class="text-center">Lista general de alumnos</h1></div>
            </div><!--fin del row -->
            <div class="row">
                <table id="datatables" class="table table-bordered table-hover dataTable" role="grid" >
                    <thead>
                        <tr>
                            <th>Matrícula</th><th>Alumno</th><th>Plan</th><th>Grado</th><th>Clave</th><th>Materia</th><th>Expediente</th><th>Maestro</th><th>Grupo</th>
                            <th>Oportunidad</th><th>Observación</th><th>Día Ordi.</th><th>Fecha Ordi.</th><th>Inicio</th>
                            <th>Fin</th><th>Aula</th><th>Día Extra.</th><th>Fecha Extra.</th><th>Inicio</th>
                            <th>Fin</th><th>Aula</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
