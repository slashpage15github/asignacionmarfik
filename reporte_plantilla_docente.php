<?php
    ...
    $sql="select alumnos,clave,materia,progra_grupo,grupo,expediente,maestro,horas,hilunes,hflunes,mlunes,slunes,
        himartes,hfmartes,mmartes,smartes,himiercoles,hfmiercoles,mmiercoles,smiercoles,
        hijueves,hfjueves,mjueves,sjueves,hiviernes,hfviernes,mviernes,sviernes,hisabado,hfsabado,msabado,ssabado,departamental,semestre,observacion from ofertaacademica";
...
<body>
    ...
    <div container-fluid" align="center">
        <div class="col-md-12">
            ...
            <div class = "row">
                <div class="col-md-12"><h1 class="text-center">Reporte Plantilla Docente</h1></div>
            </div><!--fin del row -->
            <div class="row">
