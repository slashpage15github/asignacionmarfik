...
<body>
    ...
    <div container-fluid" align="center">
        <div class="col-md-12">
            ...
            <div class = "row">
                <div class="col-md-12"><h1 class="text-center">Fecha examenes departamentales ordinarios y extraordinarios.</h1></div>
                
            </div><!--fin del row -->
            <div class="row">
                <a href="agregar_examenes.php" style="text-decoration: none; color: #000;">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr value="<?=$semestre;?>">
                                    ...
                                    <td><?=$f_inicio;?></td>
                                    <td><?=$f_fin;?></td>
                                    <td><a href="editar_examenes.php?semestre=<?=$semestre;?>&tipo_examen=<?=$tipo_examen;?>" style="text-decoration: none; color: #000;">
    ...
    <script>
        $(document).ready(function(){
            $(".borrar").on("click",function(){
                var semestre= $(this).parents('tr').find('td').eq(0).text();
                var borrar= confirm("¿Desea borrar?");
                if(borrar){
                    $.post("eliminarexamen.php", {semestre: semestre}, function() {
                        location.reload();
