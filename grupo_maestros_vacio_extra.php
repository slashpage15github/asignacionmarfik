<?php
  ...
  $sql="select * from gruposmaestros where (dia_extra is null or dia_extra='');";
//print $sql;exit;
...
<head>
    ...
    <title>REPORTE GRUPO MAESTROS EXTRAORDINARIO VACIO FS</title>
    <!-- Bootstrap Core CSS -->
            ...
            /*'copyHtml5',*/
             {
                ...
                text:"Exporta Excel",
                title:"maestros_vacio_extra"+(GetTodayDate()),
            },
            {
            /*'csvHtml5',*/
                extend: 'pdf',
...
<body>
    ...
    <div container-fluid" align="center">
        <div class="col-md-12">
            ...
            <div class = "row">
                <div class="col-md-12"><h1 class="text-center">REPORTE GRUPO MAESTROS EXTRAORDINARIO VACIO</h1></div>
            </div><!--fin del row -->
            <div class="row">
