...
<head>
    ...
    <title>Asignación puntual ExtraOrdinario Grupal</title>
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <div id = "contenedor">
        <div class="col-md-12">
            <form class="form-inline" action="log_forma_grupos_abc_extra.php" method="POST">
                ...
                <div class = "row">
                    <div class="col-md-12"><h1 class="text-center">Modificación de Grupos (Extraordinarios)</h1></div>
