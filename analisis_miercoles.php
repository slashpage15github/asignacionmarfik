<?php
  ...
  $sql="select alumnos,clave,materia,grupo,expediente,maestro,himiercoles,hfmiercoles,
mmiercoles,smiercoles 
from ofertaacademica
where (himiercoles is not null and himiercoles<>'')
ORDER BY smiercoles asc,himiercoles asc";
//print $sql;exit;
...
<head>
    ...
    <title>Analisis de oferta academica Miercoles</title>
    <!-- Bootstrap Core CSS -->
            ...
            /*'copyHtml5',*/
             {
                ...
                text:"Exporta Excel",
                title:"Analisis de oferta academica Miercoles"+(GetTodayDate()),
            },
            {
            /*'csvHtml5',*/
                extend: 'pdf',
...
<body>
    ...
    <div container-fluid" align="center">
        <div class="col-md-12">
            ...
            <div class = "row">
                <div class="col-md-12"><h1 class="text-center">Analisis de oferta academica Miercoles</h1></div>
            </div><!--fin del row -->
            <div class="row">
                <table id="datatables" class="table table-bordered table-hover dataTable" role="grid" >
                    ...
                    <tbody>
                            ...
                            while($row=mysqli_fetch_array($resultado,MYSQLI_ASSOC)){
                                ...
                                $mmiercoles=trim(utf8_encode($row["mmiercoles"]));
