<?php
	...
	if (isset($_POST['matric'])) {
		$_SESSION['$matriculaa'] = $_matric = $_POST['matric'];
...
<head>
	...
	<title>Modificación de horario Extraordinario por alumno</title>
</head>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12 text-center">
				<h1 class="sinMargen"><a class="btn btn-danger" href="consulta_extra_alumno.php" role="button">Buscar Matrícula</a>&nbsp;&nbsp;Ajuste individual Extraordinarios por alumno </h1>
			...
			<div class="col-lg-12 text-center">
				...
				<i><?php
					...
					if (strlen($matrix==0)){
						...
						echo "location.href = 'consulta_extra_alumno.php';";
						echo "</script>";
						return;
					}
				?></i>
		...
		<?php
			...
			$_dia_extra=""; $_fecha_extra=""; $_horai_extra=""; $_horaf_extra=""; $_aula_extra=""; $alumno="";
			...
			if (isset($_GET['md']) and isset($_GET['exp']) AND isset($_GET['cve']) AND isset($_GET['gpo'])) {
				...
				/*$_dia_ordi = $o_alumno->getDiaExtra();
				$_fecha_ordi = $o_alumno->getFechaExtra();
				$_horai_ordi = $o_alumno->getHoraiExtra();
				$_horaf_ordi = $o_alumno->getHorafExtra();
				$_aula_ordi = $o_alumno->getAulaExtra();*/
		...
		<div id="container">
		<form action="log_forma_alumnos_extra_abc.php" name="alumno_extra" onsubmit="return valida_alumno_extra();" method="post">
				...
				<div class='col-md-12'>
                	...
                	<div class="col-md-2 form-group">
                		<label>Fecha</label>
                    	<input style="background: white;" type="text" id="f_fecha" name="f_fecha" class="form-control" value="<?=$_fecha_extra;?>" readonly>
                	</div>
                	<div class="col-md-2 form-group">
                    	<label>Día</label>
                    	<input style="background: white;" type="text" id="f_dia" name="f_dia" class="form-control" value="<?=utf8_encode($_dia_extra);?>" readonly>
                    </div>
				</div>
				...
				<div class='col-md-12'>
                	<div class="col-md-2 form-group">
                    	...
                    	<input  type="text" id="f_hi" name="f_hi" class="form-control" value="<?=$_horai_extra;?>">
                	</div>
                	<div class="col-md-2 form-group">
                    	<label>Hora Fin</label>
                    	<input type="text" id="f_hf" name="f_hf" class="form-control" value="<?=$_horaf_extra;?>">
                	</div>
                	<div class="col-md-6 form-group">
						...
						<?php
							...
							saca_menu_desplegable_boostrap_alumnos($consulta,$_aula_extra, "f_aula_extra", 
							"f_aula_extra");
		 				?>
                	</div>
                	<div class="col-md-2 form-group">
		...
		<?php
			...
			{				
				...
				$o_alumno->setFechaExtra($_POST['f_fecha']); // setea los datos nuevos
				$o_alumno->setDiaExtra($_POST['f_dia']);
				$o_alumno->setHoraiExtra($_POST['f_hi']);
				$o_alumno->setHorafExtra($_POST['f_hf']);
				$o_alumno->setAulaExtra($_POST['f_aula_extra']);

				print '¡Horario modificado!'. $o_alumno->updateAlumnoExtra();
			}
								...
								<center>
									...
									while($row = mysql_fetch_array($_pagi_result)) {
										print 	'<tr>'
												...
												/*.'<td>'.$row['dia_ordi'].' | '.$row['fecha_ordi'].' | '.$row['horai_ordi'].' | '.$row['horaf_ordi'].' | '.$row['aula_ordi'].'</td>'*/
												...
												.'<td><a href="log_forma_alumnos_extra_abc.php?exp='.$row['expediente'].'&gpo='.$row['grupo'].'&cve='.$row['clave'].'&md='.$_SESSION['$matriculaa'].'&_pagi_pg='.$_pagi_pg.'"><img src="pics/modificar.png" border="0" style="position:relative;left:12px;"></a></td>'   
												.'</tr>';
									}
									echo '</table>';
								echo '</center>';
