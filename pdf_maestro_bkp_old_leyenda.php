...
$pdf->ezTable($data,array('Num'=>'Num.',
                  ...
                  'Extraordinarios'=>'Extraordinario(s)'
					),'',array('shadeCol'=>array(0.9,0.9,0.9),'shaded'=>0,'fontSize'=>9,'showLines'=>2, 'width'=>900,'cols'=>array('Num'=>array('width'=>40,'justification'=>'center'),
...
$text2 = utf8_decode('Los exámenes están estimados para una duración de dos horas clase para materias no departamentales y 3 horas clase para materias departamentales.');
$y = 270;   
...
$pdf ->addJpegFromFile('images/bullet1.jpg',51,259,8,9);
/*
$text3 = utf8_decode('Dar a conocer los resultados antes de confirmar en el STA, por lo que se le sugiere aprovechar la fecha de aplicación para indicar a sus alumnos, el día, hora y salón en el que les mostrará sus exámenes y dará a conocer su calificación final.');
*/
$text3 = utf8_decode('Dar a conocer los resultados antes de confirmar en el sistema que será asignado posteriormente, por lo que se le sugiere aprovechar la fecha de aplicación para indicar a sus alumnos, el día y hora en el que les mostrará sus exámenes y dará a conocer su calificación final. El examen debe ser aplicado en el grupo de TEAMS en el cual fue impartida la clase.');
...
$text6 = utf8_decode('En caso de tener alumnos con calificación ordinaria 222 (SD ó NP) en el Acta de Evaluación Ordinaria, y que no tenga derecho ó no se presenten al examen extraordinario, SE DEBERÁ GENERAR Y ENTREGAR EL ACTA DE EVALUACIÓN EXTRAORDINARIA CORRESPONDIENTE, EN EL TIEMPO ESTABLECIDO.');
$y = 190;   
...
/*
$text8 = utf8_decode('IMPORTANTE: Entregar Exámenes y Actas de Evaluación confirmadas a Control Escolar, dentro de los tres días después de la fecha de aplicación.');
*/
$text8 = utf8_decode('IMPORTANTE: Enviar las Actas de Evaluación Escaneadas y con firma autógrafa, al correo facultaddesistemasus@uadec.edu.mx dentro de los tres días después de la fecha de aplicación.');
