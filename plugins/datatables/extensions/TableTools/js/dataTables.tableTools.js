	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		...
		$(document).bind( "keydown.DTTT", function(e) {
			...
			if ( e.keyCode == 27 )
			{
				/*Lineas personalizadas para que se visualice en el sistema SCEBasica*/
				var ss = document.getElementById('principal');
				ss.style.marginLeft= "230px";
				/*----------------------------------------------*/
				e.preventDefault();
...
TableTools.BUTTONS = {
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6>Vista de Impresion</h6><p>Favor de usar la funcion de Impresion "+
		  "para poder imprimir esta consulta. Presione la tecla <strong>ESC</strong> para finalizar.</p>",
		"sMessage": null,
		"bShowAll": true,
